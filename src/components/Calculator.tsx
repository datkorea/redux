...
const Calculator: React.FC = () => {
    ...
    return (
        <div className='w-50 mx-auto mt-5  p-4'>
            ...
            <button onClick={handleCong} className="btn btn-primary">Cộng</button>
            <button onClick={handleTru} className="btn btn-danger">Trừ</button>
            <button onClick={handleNhan} className="btn btn-success">Nhân</button>
            <button onClick={handleChia} className="btn btn-warning">Chia</button>
